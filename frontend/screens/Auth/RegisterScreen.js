...
export default function RegisterScreen() {
  ...
  return (
    <View className="flex-1 bg-white px-6 justify-center">
      ...
      <Text className="text-2xl font-bold text-black mb-6 text-center">REGISTER</Text>
      ...
      <View className="flex-row mb-6">
        ...
        >
          <View className={`w-4 h-4 rounded-full border border-black mr-2 ${role === 'User' ? 'bg-black' : ''}`} />
        ...
        >
          <View className={`w-4 h-4 rounded-full border border-black mr-2 ${role === 'Admin' ? 'bg-black' : ''}`} />
      ...
      >
        <Text className="text-white text-center font-bold text-base">Signup</Text>
      </TouchableOpacity>
